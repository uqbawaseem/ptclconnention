   ...
   include('config.php');
     if (isset($_POST['submit'])) {
        ...
        if(empty($_POST['name']) || empty($_POST['email']) || empty($_POST['password']) || empty($_POST['phone']))
         ...
         {
            $query = "INSERT INTO `driver`(`name`, `email`, `password`, `phone`) VALUES ('$name','$email','$password','$phone')";
            $result  = mysqli_query($connection, $query);
            echo "<font color='red'>Driver Register seccessfully.</font>";
      ...
      <section class="login-wrapper">
         ...
         <center><h3>Register now</h3>
            <div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
               <form action="new_driver.php" method="post" enctype="multipart/form-data">
